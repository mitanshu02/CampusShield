...
#     # if payment scan found high risk — upgrade explanation and attack type
#     if (payment_result and
#         payment_result.get("available") and
#         payment_result.get("payment_risk", 0) >= 70 and
#         overall_risk >= 60):
#         explanation = (
#             "This page contains multiple signs of UPI payment fraud. "
#             "It requests your UPI PIN directly on a webpage — something "
#             "no legitimate app ever does. The page also uses language "
#             "associated with fake refund and cashback scams. "
#             "Do not enter any payment details here."
#         )
